...
public final class PreferencesActivity extends PreferenceActivity
  ...
  public static final String KEY_DECODE_1D = "preferences_decode_1D"; //解一维码
  public static final String KEY_DECODE_QR = "preferences_decode_QR"; //解QR码
  public static final String KEY_DECODE_DATA_MATRIX = "preferences_decode_Data_Matrix"; //解矩阵码
  public static final String KEY_CUSTOM_PRODUCT_SEARCH = "preferences_custom_product_search"; //自定义搜索网址
  ...
  public static final String KEY_FRONT_LIGHT = "preferences_front_light";             //前灯
