...
public final class BarcodeActivity extends Activity implements SurfaceHolder.Callback {
	...
	public void onCreate(Bundle icicle) {
		...
		FrameLayout.LayoutParams parm3 =  new FrameLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
		parm3.gravity = Gravity.TOP | Gravity.CENTER_HORIZONTAL;
		parm3.topMargin = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 20, dispm);
		...
		parm4.gravity = Gravity.BOTTOM;// | Gravity.CENTER_HORIZONTAL;
	...
	private void initCamera(SurfaceHolder surfaceHolder) {
		...
		if (handler == null) {
			handler = new BarcodeActivityHandler(this, decodeFormats,
					characterSet);
		}
	}
