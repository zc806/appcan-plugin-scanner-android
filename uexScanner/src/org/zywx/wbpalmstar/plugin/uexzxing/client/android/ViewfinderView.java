...
//  private final int frameColor;
  ...
  public ViewfinderView(Context context, AttributeSet attrs) {
    ...
    paint = new Paint();
    maskColor = 0x60000000;//该颜色是设定非扫描区的颜色，需要改成透明
    resultColor = 0xb0000000;//该颜色未在二维码扫描界面显示，可能为扫描结果的颜色
//    frameColor = 0xff000000;
    laserColor = 0xffffffff;//该颜色为改变扫描框体颜色
    resultPointColor = 0xc0ffff00;//该颜色未在二维码扫描界面显示，可能跟扫描结果有关系
    scannerAlpha = 0;
  ...
  public void onDraw(Canvas canvas) {
    ...
    if (resultBitmap != null) {
        ...
        Drawable d = getResources().getDrawable(EUExUtil.getResDrawableID("plugin_scanner_frame"));
        ...
        canvas.drawText("将二维码/条形码放置框内，即开始扫描", width/2, (float) (frame.bottom + (float)TEXT_PADDING_TOP *density), paint);
